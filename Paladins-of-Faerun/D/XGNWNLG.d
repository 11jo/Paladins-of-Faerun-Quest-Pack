...
~ THEN REPLY @1 DO ~GiveItemCreate("XGPLA1M",Player1,0,0,0)
GiveItemCreate("XGGLAV1",Player1,0,0,0)
...
GiveItemCreate("XGCLCK1",Player1,0,0,0)
...
GiveItemCreate("XGLEAT1",Player1,0,0,0)
...
GiveItemCreate("XGFALH2",Player1,0,0,0)
GiveItemCreate("MISC07",Player1,500,0,0)
SetNumTimesTalkedTo(1)~ GOTO 1
  IF ~  Class(Player1,PALADIN_ALL)
~ THEN REPLY @6 DO ~GiveItemCreate("POTN52",Player1,5,0,0)
GiveItemCreate("XGPLA1M",Player1,0,0,0)
GiveItemCreate("XGBSWO2",Player1,0,0,0)
...
GiveItemCreate("XGIK02",Player1,0,0,0)
GiveItemCreate("MISC07",Player1,500,0,0)
SetNumTimesTalkedTo(1)~ GOTO 1
END
