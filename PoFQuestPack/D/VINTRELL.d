...
Global("s#SKWR4MOD","GLOBAL",0)~ THEN BEGIN 5
  SAY @13
  IF ~~ THEN REPLY @14 EXIT
END

IF ~  Global("s#VINTRELL","GLOBAL",1)
Global("s#SKWR4MOD","GLOBAL",1)~ THEN BEGIN 6
  SAY @13
...
IF ~  Global("s#VINTRELL","GLOBAL",1)
Global("s#SKWR4MOD","GLOBAL",2)~ THEN BEGIN 9
  SAY @13
...
Global("s#SABAT","GLOBAL",0)~ THEN BEGIN 11
  SAY @13
  IF ~~ THEN REPLY @14 EXIT
END

IF ~  Global("s#VINTRELL","GLOBAL",2)
Global("s#SABAT","GLOBAL",1)~ THEN BEGIN 12
  SAY @13
