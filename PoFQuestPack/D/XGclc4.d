...
IF ~Global("s#XGclc4","GLOBAL",0)~ THEN BEGIN 0
  SAY @0
...
IF ~~ THEN BEGIN 1
  SAY @2
  IF ~~ THEN REPLY @3 DO ~SetGlobal("s#XGclc4","GLOBAL",1)~ EXIT
...
IF ~Global("s#XGclc4","GLOBAL",2)
!PartyHasItem("XGqic")~ THEN BEGIN 5
  SAY @13
  IF ~~ THEN REPLY @14 EXIT
END

IF ~Global("s#XGclc4","GLOBAL",2)
PartyHasItem("XGqic")~ THEN BEGIN 6
  SAY @13
