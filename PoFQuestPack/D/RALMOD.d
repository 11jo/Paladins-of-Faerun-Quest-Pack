...
IF ~Global("s#RALMOD","GLOBAL",0)~ THEN BEGIN 0
  SAY @0
...
IF ~~ THEN BEGIN 2
  SAY @6
  IF ~~ THEN REPLY @7 DO ~SetGlobal("s#RALMOD","GLOBAL",1)~ GOTO 3
END
...
IF ~~ THEN BEGIN 4
  SAY @9
  IF ~~ THEN REPLY @10 DO ~TakePartyGold(10000) Reputationinc(-2) SetGlobal("s#RALMOD","GLOBAL",2)~  GOTO 6
END

IF ~Global("s#RALMOD","GLOBAL",1)~ THEN BEGIN 5
  SAY @11
...
CreateCreature("FIGGMOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",2)
Dead("FIGGMOD")~ THEN BEGIN 7
  SAY @16
...
IF ~~ THEN BEGIN 8
  SAY @19
  IF ~~ THEN REPLY @20 DO ~SetGlobal("s#RALMOD","GLOBAL",3)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("BSMSEMOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",3)
Dead("BSMSEMOD")~ THEN BEGIN 9
  SAY @21
...
IF ~~ THEN BEGIN 10
  SAY @22
  IF ~~ THEN DO ~SetGlobal("s#RALMOD","GLOBAL",4)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("MGG1MOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",4)
Dead("MGG1MOD")~ THEN BEGIN 11
  SAY @23
...
IF ~~ THEN BEGIN 12
  SAY @25
  IF ~~ THEN DO ~SetGlobal("s#RALMOD","GLOBAL",5)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("RGGMOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",5)
Dead("RGGMOD")~ THEN BEGIN 13
  SAY @26
...
IF ~~ THEN BEGIN 14
  SAY @28
  IF ~~ THEN DO ~SetGlobal("s#RALMOD","GLOBAL",6)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("DGMOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",6)
Dead("DGMOD")~ THEN BEGIN 15
  SAY @29
...
IF ~~ THEN BEGIN 16
  SAY @31
  IF ~~ THEN DO ~SetGlobal("s#RALMOD","GLOBAL",7)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("BARGGMOD",[1767.1245],4)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",7)
Dead("BARGGMOD")~ THEN BEGIN 17
  SAY @32
  IF ~~ THEN REPLY @30 DO ~SetGlobal("s#RALMOD","GLOBAL",8)
GiveItemCreate("MISC07",Player1,8000,0,0)
ActionOverride(Player1,LeaveAreaLUA("PF0075","",[1313.1221],12))
CreateCreature("CHGMOD",[1767.1245],4)~ EXIT
  IF ~~ THEN REPLY @18 EXIT
END

IF ~Global("s#RALMOD","GLOBAL",8)
Dead("CHGMOD")~ THEN BEGIN 18
  SAY @33
...
SetGlobal("s#RALMOD","GLOBAL",9)~ EXIT
END

IF ~Global("s#RALMOD","GLOBAL",9)~ THEN BEGIN 19
  SAY @35 
