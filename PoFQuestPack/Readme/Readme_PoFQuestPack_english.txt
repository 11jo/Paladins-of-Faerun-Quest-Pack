...
Standard for WeiDU mods. For the mod, SOA + TOB + the latest patch is required. Unzip the contents of the archive into the directory with the game, and run SETUP-PoFQuestPack.exe.
